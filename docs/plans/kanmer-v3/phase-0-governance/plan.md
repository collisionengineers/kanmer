...
### 0.2 Verify the backfill FRDs (015–023) against code — M · [[DOC-002]]
...
### 0.3 Seed the roadmap onto the existing v2 board — M · [[DOC-003]]
