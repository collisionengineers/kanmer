...
attempts:
  ...
  - attempted_at: "2026-08-23T00:42:41.532Z"
    ...
    exit_code: 0
    result: PASS
    summary: "Independent exact-head review PASS; focused GUI 28/28, core 283/283, scripts 89/89, core build, manual freshness, and diff-check PASS."
  - attempted_at: "2026-08-23T00:42:41.532Z"
    command: "external or environment-sensitive boundary"
    exit_code: null
    result: INCONCLUSIVE
    summary: "GUI typecheck retained only inherited CORE-060 dispatch/provider diagnostics; no CORE-078 diagnostic remained, and no hosted check was attached to the stacked PR."
---
Merged-main proof for CORE-078: implementation 7b355245; stacked merge is reachable through a8cc6b01
External/provider/protection limitations remain explicitly INCONCLUSIVE; no unsupported claim is made.
CORE-078 is verified against the merged cumulative mainline and is ready for the Done gate.
