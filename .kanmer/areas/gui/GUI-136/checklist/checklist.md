...
- [x] [pre-review] Return distinct public and loopback endpoints from the remote host.
- [x] [pre-review] Emit and retain the canonical loopback endpoint through the packaged child protocol.
