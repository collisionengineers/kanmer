...
describe("installer-owned MCP launcher contract", () => {
  ...
  test("wires a static source shim and installer-owned lifecycle", () => {
    ...
    for (const marker of ["!macro customInstall", "!macro customUnInstall", "WriteRegStr HKCU", "Kernel32::lstrcmpi", "Kernel32::MoveFileEx", "DeleteRegValue HKCU", "mklink /J", "${VERSION}", "RMDir /r \"$LOCALAPPDATA\\Kanmer\\mcp\""]) {
