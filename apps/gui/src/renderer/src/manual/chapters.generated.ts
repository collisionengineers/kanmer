...
export const MANUAL_CHAPTERS: readonly ManualChapter[] = Object.freeze([
  ...
  {
    "id": "backlog",
    "title": "The Backlog list",
    "body": "# FRD-011 — Backlog list view\n\n*Full specification: `docs/functional/frd/FRD-011-backlog-list-view.md`.*"
  },
  {
    "id": "dispatch",
