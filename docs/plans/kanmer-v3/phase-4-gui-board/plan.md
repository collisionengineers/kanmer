...
### 4.1 Format-3 migration prompt — M · [[GUI-005]]
...
### 4.2 Fixed columns + Board-settings shrink — M · [[GUI-006]]
...
### 4.3 Profiles editor — M (FRD-002 S2) · [[GUI-007]]
...
### 4.6 Reference files UI — M (FRD-004 R2) · [[GUI-010]]
