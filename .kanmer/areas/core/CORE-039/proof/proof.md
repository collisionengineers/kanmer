...
attempts:
  ...
  - attempted_at: "2026-08-22T01:09:00Z"
    command: "PR #145 stacked history"
    cwd: "PR #145"
    exit_code: 0
    result: PASS
    summary: "The disposable board fixture and KANMER_BOARD_ROOT seam are included in the green stack; release-notes coverage is exercised by the final 80/80 scripts rail."

---
Merged-main proof for CORE-039: the scoped change is present in merge 8a9eee57 and the authoritative hosted Windows verify passed. The one local core failure is retained, not erased, and remains owned by CORE-022; no assertion was weakened.
