...
- Read (`readOnlyHint`) — 16: `get_status`, `list_board`, `get_sources`, `list_items`, `get_item`, `get_execution_packet`, `reconcile_ticket`, `list_dispatches`, `get_ticket_doc`, `search_items`, `get_group`, `list_groups`, `get_group_doc`, `get_links`, `get_activity`, `get_doc_gates`
- Write — 21: `dispatch_task`, `cancel_dispatch`, `apply_reconciliation`, `create_item`, `create_items`, `update_item`, `move_item`, `take_ticket`, `set_ticket_doc`, `append_scratch`, `link_items`, `link_doc`, `add_column`, `update_column`, `reorder_columns`, `migrate_board`, `create_group`, `update_group`, `set_group_doc`, `set_sources`, `fetch_source`
