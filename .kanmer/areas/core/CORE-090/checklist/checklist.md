...
- [x] Independent review records the exact commit and merge SHA.
...
- The committed artifact changed only from the stale `7298b5c2...` / 1,590,774-byte result to `f52d9c5b...` / 1,594,808 bytes. Linked-worktree mcpb exit 1 and its stale-core export errors remain preserved.
- Independent review PASS at `75ce9ab11991994bfba46113fe3b79f5cdaaa629`; PR #220 merged into CORE-026 as `cbba69d682c448943cce87c9825589a44f4260d4`.
