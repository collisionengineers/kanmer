...
- 2026-08-22: PR opened against `core-043-protection-retarget`; independent review/merge is required. External hosted protection/Actions-variable mutation remains INCONCLUSIVE and out of scope.
