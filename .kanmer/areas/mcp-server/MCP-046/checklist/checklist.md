...
- [x] Preserve the provider workspace cwd across the quote-free temporary pushd and cover board-discovery safety in the installer launcher contract.
...
- Focused config regression: 3/3; installer launcher tests: 4/4; GUI connect.test.ts: 35/35; script rail: 97/97; plugin:check: PASS; GUI typecheck: PASS; git diff --check: PASS.
