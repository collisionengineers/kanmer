...
- [x] Rerun shared verify on the final stacked branch and preserve unrelated failures exactly. PR #145 run 32544808992/job 96961421442 passed after a retained npm ci retry.
