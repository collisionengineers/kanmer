...
### 5.1 Group chips + filter — M (FRD-001 G8) · [[GUI-013]]
...
### 5.2 Group detail view — M–L · [[GUI-014]]
...
### 5.3 Backlog list view — L (FRD-011) · [[GUI-015]]
...
### 5.4 Dispatch task picker — M (FRD-010) · [[GUI-016]]
...
### 5.5 In-app manual — M–L (FRD-024) · [[GUI-017]]
