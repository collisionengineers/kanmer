...
- [ ] `npm test`, both smokes, typecheck, GUI build, boot smoke — core 257/257, GUI 349/349, both MCP smokes, typecheck, GUI build, headless boot rerun, and scripts 79/79 passed; the root rail remains failed at unrelated MCP HTTP tests (first run 2/61, rerun 1/61) as recorded below.
