...
const LEASE_CONFLICT_PREFIXES = ["LEASE_LIVE:", "CLAIM_LIVE:", "CLAIM_NOT_OWNED:", "WORKSPACE_OCCUPIED:", "RECOVERY_REFUSED:", "LEASE_ID_REQUIRED:", "LEASE_REVISION_REQUIRED:", "BATCH_INVALID:", "BATCH_FROZEN:", "BATCH_RUN_REQUIRED:", "BATCH_OWNER_MISMATCH:", "BATCH_INCONSISTENT:", "BATCH_TRANSACTION_CONFLICT:", "BATCH_TRANSACTION_PENDING:", "BATCH_TRANSACTION_INVALID:", "BATCH_WORKSPACE_INVALID:", "BATCH_WORKSPACE_MISMATCH:", "BATCH_ACTIVE:"];
