...
5. **Publish the new record contract**
   ...
   - Update closeout/auto/tool reference/AGENTS/manual with the same authority and migration-census rules.
...
- Files: AGENTS, verify/closeout/auto skills, tool reference, manual/generated manual, prose validators, plugin bundle.
