...
attempts:
  ...
  - attempted_at: "2026-08-22T01:09:00Z"
    ...
    exit_code: 0
    result: PASS
    summary: "The deterministic ISO cutoff is included in the green stack; the previously unchecked final stacked verify is now proven by run 32544808992."

---
Merged-main proof for CORE-040: the scoped change is present in merge 8a9eee57 and the authoritative hosted Windows verify passed. The one local core failure is retained, not erased, and remains owned by CORE-022; no assertion was weakened.
